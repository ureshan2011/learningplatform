...
import { Card, PageHeader } from "@/components/ds-cream";
        ...
        <div className="mx-auto max-w-3xl px-5 py-12">
          ...
          {HOW_SECTION ? (
            <Card radius="card" className="mt-8 p-6">
              ...
              <p className="mt-2.5 text-sm leading-relaxed text-ict-ink-500">
                {HOW_SECTION.body.en}
              </p>
            </Card>
          ) : null}
          ...
          <div className="mt-4 space-y-4">
            {FREE_TEMPLATES.map((template) => (
              <Card key={template.label.en} radius="card" className="p-6">
                ...
                <pre className="mt-3 overflow-x-auto rounded-ict-md border border-ict-paper-300 bg-ict-paper-0 p-4 font-mono text-xs leading-relaxed whitespace-pre-wrap text-ict-ink-900">
                  {template.text}
                </pre>
              </Card>
            ))}
