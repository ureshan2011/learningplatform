    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-5 py-12">
        ...
        <p className="mt-3 text-sm text-ict-fg-soft">
          ...
          <Link href="/logic-gates" className="text-ict-accent-fg underline">
        ...
        <section className="mt-10">
          ...
          <div className="mt-4 overflow-x-auto">
            <table className="w-full min-w-[480px] border-collapse text-sm">
              ...
              <tbody>
                {BASES.map((b) => (
                  <tr key={b.name} className="border-b border-ict-line last:border-0">
                    <td className="py-2 pr-4 font-semibold text-ict-fg">{b.name}</td>
                    <td className="py-2 pr-4 font-mono">{b.base}</td>
                    <td className="py-2 pr-4 font-mono">{b.digits}</td>
                    <td className="py-2 text-ict-fg-soft">{b.note}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section className="mt-12">
              ...
              <tbody>
                {steps.map((s, i) => (
                  <tr key={i} className="border-b border-ict-line last:border-0">
                    ...
                    <td className="py-1.5 font-mono font-bold text-ict-accent-fg">{s.remainder}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <p className="mt-3 text-sm text-ict-fg-soft">
            Reading remainders bottom to top: <span className="font-mono font-semibold text-ict-fg">{binaryOf156}</span>. Check
            ...
            {PRACTICE.map((p) => (
              <li key={p.q}>
                <Card radius="card" className="p-4">
                  <p className="font-semibold text-ict-fg">{p.q}</p>
                  <p className="mt-2 flex items-start gap-2 text-sm text-ict-fg-soft">
