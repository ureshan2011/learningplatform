...
import { PageHeader, Card, CardLink, SectionHeading, ButtonLink, IconBadge } from "@/components/ds";
    ...
    <>
      ...
      <main className="bg-ict-surface">
        <div className="mx-auto max-w-3xl px-5 py-12">
          ...
          <Card variant="feature" radius="panel" className="mt-6 flex flex-wrap items-center justify-between gap-4 p-6">
            <div>
              <p className="font-display text-lg font-extrabold text-ict-on-feature">
                Prefer it already taught, not just listed<span className="text-ict-orange-500">?</span>
              </p>
              <p className="mt-1.5 text-sm text-ict-on-feature-soft">
          ...
          <section lang="si" className="si mt-8">
            <Card radius="card" className="p-6">
              ...
              <p className="mt-4 text-sm">
                <Link href="/syllabus/al-ict" className="font-semibold text-ict-accent-fg underline underline-offset-2">
                ...
                <Card key={doc.name} radius="card" className="flex gap-4 p-5">
                  ...
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-baseline gap-2">
                      <h3 className="font-display font-bold text-ict-fg">{doc.name}</h3>
                      <span className="text-xs text-ict-fg-mute">{doc.also}</span>
                    </div>
                    <p className="mt-2 text-sm text-ict-fg-soft">{doc.body}</p>
                    <p className="mt-2 text-xs font-semibold text-ict-accent-fg">{doc.who}</p>
                  </div>
                </Card>
              ))}
            </div>
          ...
          <section className="mt-12">
            ...
            {[
              ...
              <div key={year} className="mt-6">
                <h3 className="font-display text-lg font-extrabold text-ict-fg">
                  Grade {year}
                  <span className="ml-2 text-sm font-normal text-ict-fg-mute">
