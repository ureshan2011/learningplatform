...
import { Card, EmptyState, IconBadge, PageHeader } from "@/components/ds";
                  ...
                  <Card radius="card" className="flex flex-wrap items-center justify-between gap-3 p-4">
                    <div className="flex min-w-0 items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <p className="truncate font-semibold text-ict-fg">{item.title}</p>
                        <p className="mt-0.5 text-xs text-ict-fg-mute">
                    ...
                    <a
                      ...
                      className="ict-press inline-flex h-9 shrink-0 items-center gap-1.5 rounded-full border-[1.5px] border-ict-line-strong px-4 text-sm font-semibold text-ict-fg transition-colors duration-[120ms] ease-ict hover:border-ict-line-strong-hover hover:text-ict-accent-fg"
                    >
