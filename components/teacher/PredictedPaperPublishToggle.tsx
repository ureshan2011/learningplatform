...
export function PredictedPaperPublishToggle({ published }: { published: boolean }) {
  ...
  return (
    <div className="rounded-ict-md border border-ict-line bg-ict-surface-card shadow-[0_1px_3px_rgba(0,0,0,0.04)] p-5">
        ...
        <button
          ...
          className={
            published
              ...
              : "shrink-0 rounded-full bg-ict-orange-500 hover:bg-ict-orange-600 px-5 py-2.5 font-semibold text-white disabled:opacity-50"
          }
        >
