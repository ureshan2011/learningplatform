    ...
    >
      ...
      {def.double ? (
        <>
          ...
          <circle cx={15} cy={45} r={3} fill="var(--color-ict-fg)" stroke="none" />
          <circle cx={15} cy={95} r={3} fill="var(--color-ict-fg)" stroke="none" />
          <text x={12} y={36} fontSize={16} fontWeight={700} stroke="none" fill="var(--color-ict-fg-mute)">
            A
          </text>
          <text x={12} y={116} fontSize={16} fontWeight={700} stroke="none" fill="var(--color-ict-fg-mute)">
            B
          </text>
        </>
      ) : (
        <>
          ...
          <circle cx={15} cy={70} r={3} fill="var(--color-ict-fg)" stroke="none" />
          <text x={12} y={61} fontSize={16} fontWeight={700} stroke="none" fill="var(--color-ict-fg-mute)">
            A
          </text>
        </>
      )}
      ...
      <path d={def.body} fill="var(--color-ict-surface-card)" />
      {def.extra ? <path d={def.extra} fill="none" /> : null}

      {/* Output line, with an inverting bubble for NAND/NOR/NOT/XNOR */}
      {def.inverted ? (
        <circle cx={bubbleCx} cy={70} r={7} fill="var(--color-ict-surface-card)" />
      ) : null}
      <line x1={outputStartX} y1={70} x2={205} y2={70} />
      <circle cx={205} cy={70} r={3} fill="var(--color-ict-fg)" stroke="none" />
      <text x={198} y={100} fontSize={16} fontWeight={700} stroke="none" fill="var(--color-ict-fg-mute)" textAnchor="end">
        Q
      </text>
    </svg>
  );
